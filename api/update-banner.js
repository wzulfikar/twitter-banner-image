...
function getImageUrl(tz1, tz2) {
  ...
  return `https://og-image.wzulfikar.com/i/**Time%20is**%3Cbr%2F%3E%F0%9F%87%AE%F0%9F%87%A9%20${wibTime}%3Cbr%2F%3E%F0%9F%87%AB%F0%9F%87%AE%20${helsinkiTime}.png?theme=dark&md=1&fontSize=100px&images=NO_IMAGE`;
}
...
export default async function handler(req, res) {
  try {
    const base64Banner = await getImageBase64(getImageUrl());
